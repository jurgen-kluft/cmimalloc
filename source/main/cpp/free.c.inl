...
#    include "cmimalloc/private/prim.h" // _mi_prim_thread_id()
#endif
...
mi_decl_nodiscard size_t mi_usable_size(const void* p) mi_attr_noexcept { return _mi_usable_size(p, "mi_usable_size"); }
